    ...
    <div className="relative min-h-screen overflow-x-hidden bg-background">
      ...
      <footer className="container border-t border-border py-10 text-center text-sm text-muted-foreground">
        ...
        <div className="mx-auto mt-6 max-w-2xl space-y-1 border-t border-border/50 pt-6 text-xs text-muted-foreground/80">
          ...
          <button
            onClick={() => setPrivacy(true)}
            className="mt-2 text-secondary underline-offset-2 transition hover:underline"
          >
      ...
      {privacy && (
        ...
        >
          <div
            className="relative flex max-h-[88vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-border bg-card"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-border px-6 py-4">
              <h3 className="font-display text-base font-bold uppercase tracking-tight text-foreground md:text-lg">
                Политика обработки персональных данных
              </h3>
              <button
                onClick={() => setPrivacy(false)}
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-border text-foreground transition hover:bg-muted"
                aria-label="Закрыть"
              >
                <Icon name="X" size={20} />
              </button>
            ...
            <div className="space-y-5 overflow-y-auto px-6 py-6 text-sm leading-relaxed text-muted-foreground">
              <p>
                Настоящая Политика обработки персональных данных (далее — «Политика») разработана в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению их безопасности, принимаемые Индивидуальным предпринимателем Черниковым Сергеем Николаевичем (далее — «Оператор»), при использовании сайта thai-fruits.ru (далее — «Сайт»).
              </p>
              ...
              {[
                {
                  ...
                  items: [
                    'Оператор: ИП Черников Сергей Николаевич, ИНН [указать полностью], ОГРНИП [указать полностью], юридический адрес: г. Владивосток, Приморский край, РФ.',
                ...
                },
                {
                  ...
                  items: [
                    'Данные, предоставляемые Пользователем самостоятельно при оформлении заказа или подписке: ФИО, номер телефона, адрес электронной почты, адрес доставки.',
                    'Данные, собираемые автоматически: IP-адрес, информация из cookie-файлов, данные о браузере, дата и время доступа к Сайту, адреса запрашиваемых страниц (собираются с помощью сервиса «Яндекс.Метрика»).',
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    'Связь с Пользователем, включая направление уведомлений, запросов и информации, касающейся заказа.',
                    'Информирование о новых поступлениях, акциях и предложениях (при наличии согласия на рассылку).',
                    'Проведение статистических и иных исследований для улучшения качества сервиса.',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'Договор, стороной которого является Пользователь (оформление заказа на Сайте).',
                    'Иные основания, предусмотренные законодательством РФ.',
                  ],
                },
                {
                  title: '5. Порядок сбора, хранения, передачи и иной обработки персональных данных',
                  items: [
                    ...
                    'Оператор вправе передавать персональные данные третьим лицам в следующих случаях: курьерским и логистическим службам — для целей доставки заказа; операторам платёжных систем — при онлайн-оплате заказа; государственным органам — по законному запросу.',
                    'Оператор не передаёт персональные данные третьим лицам в иных случаях без согласия Пользователя, за исключением случаев, установленных законодательством РФ.',
                    'Срок хранения персональных данных — не более 3 (трёх) лет с момента последнего обращения Пользователя, если иной срок не установлен законодательством РФ.',
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    'Для реализации указанных прав Пользователь может обратиться к Оператору по контактным данным, указанным в разделе 8 настоящей Политики.',
                  ],
                },
                {
                  title: '7. Файлы cookie и счётчики аналитики',
                  items: [
                    'Сайт использует файлы cookie и сервис «Яндекс.Метрика» для анализа посещаемости, поведения пользователей и улучшения работы Сайта.',
                    'Пользователь может отключить cookie в настройках своего браузера, однако это может повлиять на корректную работу отдельных функций Сайта.',
                  ],
                },
                {
                  title: '8. Контактная информация Оператора',
                  items: [
                    'По всем вопросам, связанным с обработкой персональных данных, Пользователь может обратиться: по электронной почте: keranos@mail.ru; в Telegram: @Keranos1st; по адресу: г. Владивосток, Приморский край, РФ.',
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    'Действующая редакция Политики всегда доступна на странице: thai-fruits.ru/privacy.',
                  ],
                },
              ].map((section) => (
              ...
              <p className="text-muted-foreground/70">Редакция от [дата публикации]</p>
            </div>
          </div>
        </div>
      )}
